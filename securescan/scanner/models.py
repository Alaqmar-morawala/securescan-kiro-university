...
class Target(models.Model):
    ...
    secret_header_name = models.CharField(max_length=120, blank=True, default="")
    secret_header_value = models.CharField(max_length=500, blank=True, default="")
...
class ScanConfig(models.Model):
    ...
    target = models.ForeignKey(Target, on_delete=models.CASCADE, related_name="configs")
    scan_type = models.CharField(max_length=16, choices=SCAN_TYPES, default="baseline")
...
class Scan(models.Model):
    ...
    config = models.ForeignKey(ScanConfig, on_delete=models.CASCADE, related_name="scans")
